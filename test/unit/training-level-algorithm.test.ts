...
describe("Algorithme de niveau moyen d'entraînement (T-US09-01)", () => {
  it("calcule la moyenne d'une équipe homogène sans clamp", () => {
    ...
    expect(result).toEqual({ referenceLevel: 20, opponentLevel: 20, wasClamped: false });
  });
